  ...
  return (
    <section className="">
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">
          Bekijk hier mijn <Link href="https://eduofficenl-my.sharepoint.com/:w:/g/personal/501077_vistacollege_nl/EeSiSTLCkVRKtk3B5qpXV_cBvbRJnLrPs8JmgZMk4bbZ-Q?e=7Yq43J" className="inline-button">Reflectie.</Link>
        </p>
      </div>
    </section>
  );
